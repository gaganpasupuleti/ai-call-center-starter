...
export const SCENARIOS = {
  en: {
    ...
    // Softener recovers mid-word truncations of "interested"; keep phrase ASR-stable.
  ...
  te: {
    // English ASR fixtures + session language=te (stt_language=en) for Gate C/F stability.
    send_details: {
